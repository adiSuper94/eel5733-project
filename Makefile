all:	email_filter calendar_filter location_updater threaded_location_updater eft
...
clean:
	rm -rf email_filter calendar_filter location_updater threaded_location_updater eft
